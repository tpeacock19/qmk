...
extern "C"
{
   ...
   * `process_layer_lock`, passing your custom keycode for the `lock_keycode`
   * arg:
   *
   ...
   *
   * This is useful to represent the current lock state, e.g. by setting an LED
   * or playing a sound. In your keymap, define
   *
