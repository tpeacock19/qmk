...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[L_MODS] = LAYOUT(KC_NO, XWBAK, KC_NO, LCTL(LSFT(KC_TAB)), KC_NO, KC_NO, LCTL(KC_TAB), KC_NO, XWFWD, KC_NO, OSL(L_SWNAV), OSM(MOD_LALT), OSM(MOD_LSFT), OSM(MOD_LCTL), XREDO, KC_DELETE, OSM(MOD_LCTL), OSM(MOD_LSFT), OSM(MOD_LALT), OSL(L_MEDIA), XUNDO, XCUT, XCOPY, OSM(MOD_LGUI), XPAST, KC_BSPC, OSM(MOD_LGUI), KC_ESCAPE, KC_TAB, LLOCK, TO(0), KC_ENTER, KC_ENTER, SWAPKEY),

	[L_NAV] = LAYOUT(KC_NO, XWBAK, KC_MS_UP, LCTL(LSFT(KC_TAB)), KC_NO, KC_NO, LCTL(KC_TAB), KC_NO, XWFWD, BASETOGG, KC_NO, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, TO(L_EMACS), TG_WIN, KC_MS_WH_LEFT, KC_MS_WH_UP, KC_MS_WH_DOWN, KC_MS_WH_RIGHT, KC_NO, KC_MS_BTN1, KC_MS_BTN2, XWTOG, TG_LIN, TO(0), KC_TRNS, LLOCK, OSL(L_WNAV)),
