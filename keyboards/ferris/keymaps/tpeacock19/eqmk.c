...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[L_WNAV] = LAYOUT(XCLOSE, XWBAK, LGUI(KC_F), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, XWFWD, KC_NO, G(KC_6), G(KC_4), G(KC_0), G(KC_2), LGUI(KC_RIGHT), LGUI(KC_LEFT), G(KC_3), G(KC_1), G(KC_5), G(KC_7), XLOCK, XWTOGL, LGUI(KC_N), G(KC_8), G(KC_EQL), G(KC_MINS), G(KC_9), LGUI(KC_E), XWTOG, KC_NO, TO(0), KC_TRNS, XSRCH, G(KC_TAB)),
